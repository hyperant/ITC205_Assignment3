...
public class Main implements IMainListener {
	...
	public void borrowBooks() {
		this.ctl = new BorrowUC_CTL(reader, scanner, printer, display, 
				 null, null, null); //Because we are access this var from within side a nested function we have two options in order to declare tha var, option 1 set it as final, option to make it global. Global seems like a better fit so I have changed the code to reflect this
	...
	public static void main(String[] args) {
        // start the GUI
		main = new Main(); //Because we are access this var from within side a nested function we have two options in order to declare tha var, option 1 set it as final, option to make it global. Global seems like a better fit so I have changed the code to reflect this
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
