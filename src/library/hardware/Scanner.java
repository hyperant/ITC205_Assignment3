...
public class Scanner extends JFrame implements IScanner {
	...
	public Scanner() {
		...
		this.lblErrorMesg = new JLabel(""); //Because we are access this var from within side a nested function we have two options in order to declare tha var, option 1 set it as final, option to make it global. Global seems like a better fit so I have changed the code to reflect this
		this.lblErrorMesg.setForeground(Color.RED);
		this.lblErrorMesg.setBounds(12, 21, 358, 16);
		panel.add(this.lblErrorMesg);
