...
public class ConfirmLoanPanel extends ABorrowPanel {
	...
	private IBorrowUIListener listener; //Because we are access this var from within side a nested function we have two options in order to declare tha var, option 1 set it as final, option to make it global. Global seems like a better fit so I have changed the code to reflect this

	/**
	 * Create the panel.
	 */
	public ConfirmLoanPanel(IBorrowUIListener list) {
		this.listener =list;
